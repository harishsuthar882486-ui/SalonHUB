...
type Props = {
  initialUser?: SalonAdmProfile;
  onSaveProfile?: (
    payload: Omit<SalonAdmProfile, "id">,
  ) => Promise<void> | void;
...
const SalAdmProfile: React.FC<Props> = ({
  initialUser = {
    id: "salonadmin-1",
    name: "salon Admin",
