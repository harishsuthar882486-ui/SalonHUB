...
type Props = {
  initialUser?: SuperAdminProfile;
  onSaveProfile?: (
    payload: Omit<SuperAdminProfile, "id">,
  ) => Promise<void> | void;
...
const SupAdmProfile: React.FC<Props> = ({
  initialUser = {
    id: "superadmin-1",
    name: "Super Admin",
    email: "superadmin@salonhub.com",
    phone: "",
    username: "superadmin",
    avatarUrl: "",
  },
